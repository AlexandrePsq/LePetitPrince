...
if __name__=='__main__':
    ...
    check_before =  f"echo '2-->1' >  {os.path.join(jobs_state_folder, '_'.join([model_name, subject])+'.txt')}"
    check_after =  f"echo '~1' >  {os.path.join(jobs_state_folder, '_'.join([model_name, subject])+'.txt')} "
