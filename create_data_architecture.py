...
for language in languages:
    ...
    for model in params.models:
        check_folder('text/{}/{}'.format(language, params.get_category(model)))
        check_folder('text/{}/{}/onsets-offsets'.format(language, params.get_category(model)))
...
check_folder('fMRI')
folders = ['predictions', 'raw-features', 'features', 'design-matrices', 'glm-indiv', 'glm-group', 'ridge-indiv', 'ridge-group', 'models', 'analysis']
