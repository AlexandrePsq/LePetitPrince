...
if __name__ == '__main__':
    ...
    for index_mask in range(len(labels)-1):
        ...
        for analysis in analysis_parameters['analysis_list']:
            for subject in subjects:
                ...
                plt.legend()
                plt.savefig(os.path.join(paths.path2derivatives, source, 'analysis', analysis_title + ' - ' + labels[index_mask+1] + ' - ' + subject  + '.png'))
                i+=1