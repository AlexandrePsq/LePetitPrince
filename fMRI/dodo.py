        ...
        for models in aggregated_models:
            for pca in pca_list:
                ...
                targets = [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'r2_test', pca_name, subject)+'.nii.gz') for subject in subjects.get_all(language, test)] \
                        ...
                        + [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'r2_test - {}'.format('threshold the averaged values'), pca_name, subject)+'.nii.gz') for subject in subjects.get_all(language, test)] \
                        + [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'r2_test - {}'.format('threshold the averaged values'), pca_name, subject)+'.png') for subject in subjects.get_all(language, test)] \
                        + [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'r2_test - {}'.format('average the thresholded values'), pca_name, subject)+'.nii.gz') for subject in subjects.get_all(language, test)] \
                        + [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'r2_test - {}'.format('average the thresholded values'), pca_name, subject)+'.png') for subject in subjects.get_all(language, test)] \
                        + [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'r2_test - {}'.format('weighted average'), pca_name, subject)+'.nii.gz') for subject in subjects.get_all(language, test)] \
                        + [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'r2_test - {}'.format('weighted average'), pca_name, subject)+'.png') for subject in subjects.get_all(language, test)] \
                        + [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'p-values - {}'.format('threshold the averaged values'), pca_name, subject)+'.nii.gz') for subject in subjects.get_all(language, test)] \
                        + [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'p-values - {}'.format('threshold the averaged values'), pca_name, subject)+'.png') for subject in subjects.get_all(language, test)] \
                        + [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'p-values - {}'.format('average the thresholded values'), pca_name, subject)+'.nii.gz') for subject in subjects.get_all(language, test)] \
                        + [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'p-values - {}'.format('average the thresholded values'), pca_name, subject)+'.png') for subject in subjects.get_all(language, test)] \
                        + [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'p-values - {}'.format('weighted average'), pca_name, subject)+'.nii.gz') for subject in subjects.get_all(language, test)] \
                        + [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'p-values - {}'.format('weighted average'), pca_name, subject)+'.png') for subject in subjects.get_all(language, test)] \
                        + [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'significative_r2 - {}'.format('threshold the averaged values'), pca_name, subject)+'.nii.gz') for subject in subjects.get_all(language, test)] \
                        + [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'significative_r2 - {}'.format('threshold the averaged values'), pca_name, subject)+'.png') for subject in subjects.get_all(language, test)] \
                        + [join(output_parent_folder, "{0}_{1}_{2}_{3}_{4}_{5}".format(output_data_type, language, models, 'significative_r2 - {}'.format('average the thresholded values'), pca_name, subject)+'.nii.gz') for subject in subjects.get_all(language, test)] \
