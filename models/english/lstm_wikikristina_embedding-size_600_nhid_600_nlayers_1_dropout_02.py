...
def load():
    ...
    mod = model.RNNModel('LSTM', 5, 600, 600, 1, dropout=0.2) # ntoken is chosen randomly, it will or has been determined during training
...
if __name__ == '__main__':
    ...
    params = Params()
    paths = Paths()
    mod = model.RNNModel('LSTM', 5, 600, 600, 1, dropout=0.2)
