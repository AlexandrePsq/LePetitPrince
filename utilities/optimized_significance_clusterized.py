...
if __name__ == '__main__':
    ...
    write(checkpoint, 'importing 4+2+2...')

    import numpy as np
    from sklearn.metrics import r2_score

    write(checkpoint, 'importing 4+2+2+4...')
    ...
    write(checkpoint, 'defining functions...')
