...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_name", type=str, default=None, help="Value for np.percentile.")
    parser.add_argument("--voxels_indexes", type=str, default=None, help="Value for np.percentile.")
    ...
    indexes = args.voxels_indexes.split(',')
